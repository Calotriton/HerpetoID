...
**What HerpetoID is.** A desktop application for non-invasive individual identification of wildlife
from natural body patterns — the ventral spots of a Pyrenean brook newt, and in time whatever
pattern the next species carries. It proposes ranked candidate matches from your own catalogue; you
confirm them.
...
If you work on photo-identification and something here would be useful in your own study, the
[source is on GitHub]({{ site.github_repo_url }}) under the MIT license, and
[issues]({{ site.github_repo_url }}/issues) are open.
